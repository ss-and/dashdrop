...
/**
 * Minimal inline icon set (1.6px stroke, squared joins) so the whole app ships
 * without an icon dependency and stays visually consistent.
 */
...
export function NavIcon({ name, className }: { name: string; className?: string }) {
  return <S className={className}>{paths[name] ?? paths.table}</S>;
}
